...
type TabItem = {
  ...
  route: string;
  image?: any; // pour l'image personnalisée
};
  ...
  return (
    ...
    >
      <SafeAreaView edges={["bottom"]} style={styles.safeArea}>
        <View style={[styles.navbar, { height: NAVBAR_HEIGHT, width: width * 0.9 }]}>
          <Animated.View
            style={[
              styles.activeCircle,
              {
              ...
              >
                {tab.image ? (
                  <Image
                    ...
                    style={[
                      styles.iconImage,
                      { tintColor: isActive ? "#6FC18A" : "#262524" },
                    ]}
                    resizeMode="contain"
                  />
                ) : (
